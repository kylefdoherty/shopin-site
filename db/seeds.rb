...
Product.create(title: "Kibble'n'Bits",      quantity: 8,  price: 10.00, seller_id: 1, description: 'A scrumptious canine treat, helps fight plaque')
Product.create(title: "Chow Down",          quantity: 4,  price: 15.00, seller_id: 2, description: 'Non-GMO wet food for a balanced doggie diet')
Product.create(title: "Horse Bully Sticks", quantity: 5,  price: 20.00, seller_id: 3, description: 'Forget those measly bull penises')
Product.create(title: "Himalayan Kong",     quantity: 9,  price: 30.00, seller_id: 6, description: 'Made of yak cheese. Stronger than vulcanized rubber')
Product.create(title: "Tugga War",          quantity: 2,   price: 40.00, seller_id: 6, description: 'Why yes, you WILL pay too much for this hemp rope knot')
